...
public class Home extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dis.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        dis.setForeground(new java.awt.Color(153, 0, 51));
        dis.setText("Display room details");
        dis.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                disActionPerformed(evt);
            }
        });
        getContentPane().add(dis, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 70, 190, -1));
        ...
        getContentPane().add(cancel, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 70, -1, -1));
    ...
    private void disActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_disActionPerformed
        // TODO add your handling code here:
        new Display_room_details().setVisible(true);
